...
class TestBorrowerViews(unittest.TestCase):
    ...
    def test_delete_verify_match_false(self, mock_logger_info, mock_logger_error, mock_jsonify, mock_verify_match):
        ...
        mock_logger_info.assert_called_with('trying to remove verify match entry - PID = 200abc123')
    ...
    def test_delete_verify_match_true(self, mock_logger_info, mock_jsonify, mock_verify_match):
        ...
        mock_logger_info.assert_called_with('match found for PID 200abc123: row removed')
