...
def bin_to_char(bin_str):
    pos = min(int(bin_str[:5], 2), len(charset)-1) # Converts 5 character binary string to a 2 digit integer. Then takes minimum between the 2 digit number and the lenght of the charset - 1.
