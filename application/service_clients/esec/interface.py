class EsecClientInterface(object):  # pragma: no cover
    ...
    def auth_sms(self, deed_xml, borrower_pos, user_id, borrower_auth_code, borrower_token):
        return self.implementation.auth_sms(deed_xml, borrower_pos, user_id, borrower_auth_code, borrower_token)
